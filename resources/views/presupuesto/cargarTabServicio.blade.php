        ...
        <div class="panel-body">
            ...
            <div class="col-md-2">
                <div class="well text-center">
                    <button class="btn btn-primary btn-lg fa-2x" type="button" name="button" @click="cargarItemServicio" :disabled="changeDisabledTabServicio">
                                        <i class="fa fa-level-down"></i>
                                    </button>
                    <br>
                    <br>
                    <button class="btn btn-primary btn-lg fa-2x" type="button" @click="btnLimpiarTabServicio" name="button">
