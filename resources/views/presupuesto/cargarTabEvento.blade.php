                            ...
                            <div class="panel-body">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p><strong>N° Pax:</strong><input v-model="input.evento.nPersonas" class="form-control" type="number" name="" value="0"></p>
                                            <p><strong>Hora:</strong><input id="horaEvento" class="form-control" type="text"></p>
                                            <p><strong>Observación:</strong><textarea v-model="input.evento.comentarios" class="form-control" name="name" rows="4" cols="100"></textarea></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="panel panel-info">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <p><strong>Días:</strong><input v-model="input.salon.dias" class="form-control" type="number" value="1"></p>
                                                    <p><strong>Descuento(%):</strong><input @change="descuentoSalon" v-model="input.salon.descuento" class="form-control" type="text" name="" value="5"></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div>
                                                <p><strong>Precio Salón/Área:</strong> <input type="text" v-model="input.salon.totalDescuento" class="form-control text-center" disabled value=""></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div>
                                                <p><strong>Precio Montaje:</strong> <input type="text" v-model="input.montaje.total" class="form-control text-center" disabled value=""></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
